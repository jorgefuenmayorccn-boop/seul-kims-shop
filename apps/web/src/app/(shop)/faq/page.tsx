...
const STATIC_FAQ: FaqEntry[] = [
  ...
  { id: 's9', category: 'Privacidad', question: '¿Cómo protegen mis datos personales?', answer: 'Cumplimos con la Ley 21.719 de Protección de Datos Personales de Chile. Tus datos se utilizan exclusivamente para gestionar tus pedidos y, si diste tu consentimiento, para enviarte comunicaciones de marketing. Puedes ejercer tus derechos de acceso, rectificación y supresión en cualquier momento desde tu cuenta o enviando un correo a contacto@seoulkims.cl.' },
