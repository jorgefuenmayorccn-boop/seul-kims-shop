...
const es: Dict = {
  ...
  checkout: {
    ...
    address:        'Dirección',
    commune:        'Comuna',
    payOnWhatsApp:  'Pagar por WhatsApp',
    processing:     'Procesando…',
    successTitle:   '¡Pedido enviado!',
    successSub:     'Te contactaremos por WhatsApp para coordinar el pago.',
  ...
  account: {
    ...
    registerSub:    'Únete a la comunidad SEUL SHOP.',
    email:          'Correo electrónico',
    password:       'Contraseña',
    name:           'Nombre completo',
...
const en: Dict = {
  ...
  checkout: {
    ...
    payOnWhatsApp:  'Pay via WhatsApp',
    processing:     'Processing…',
    successTitle:   'Order sent!',
    successSub:     'We\'ll contact you on WhatsApp to coordinate payment.',
  ...
  account: {
    ...
    registerSub:    'Join the SEUL SHOP community.',
    email:          'Email',
    password:       'Password',
    name:           'Full name',
...
const ko: Dict = {
  ...
  checkout: {
    ...
    address:        '주소',
    commune:        '지역',
    payOnWhatsApp:  'WhatsApp으로 결제',
    processing:     '처리 중…',
    successTitle:   '주문 완료!',
    successSub:     'WhatsApp으로 결제 안내를 드리겠습니다.',
    orderNumber:    '주문번호',
  ...
  account: {
    ...
    registerTitle:  '회원가입',
    registerSub:    'SEUL SHOP 커뮤니티에 참여하세요.',
    email:          '이메일',
    password:       '비밀번호',
    name:           '이름',
